...
function LoanSectors() {
  ...
  const submitHandler = (sectorName) => {
    if (actionName === "Add") {
      ...
      editLoanSector(workingID, sectorName, () => {
        setShowAddEditModal(false);
        setActionName("Add");
        setName("");
        setWorkingID(null);
          ...
          <div className="page bg-light pt-2">
            <Container>
              <div className="d-flex justify-content-between align-items-center my-1 border rounded p-2">
                <h4 className="mb-0">Loan Sectors</h4>
                <button
  ...
  return (
    <div className="bg-white p-2 rounded shadow-sm mb-2">
      ...
      <div className="clearfix text-muted">
        ...
        <small className="float-end">Total: {data.total_loan} tk</small>
      </div>
    </div>
  );
};
