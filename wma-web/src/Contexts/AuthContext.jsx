...
export const AuthProvider = ({ children }) => {
  ...
  const register = (name, email, passowrd, password_confirmation) => {
    setLoading(true);
    axios.post(`${BASE_URL}/register`, {name, email, passowrd, password_confirmation}).then(res => {
  ...
  return <AuthContext.Provider value={{loading, login, register, loadUser, user, logout, resendCode}}>{children}</AuthContext.Provider>;
};
