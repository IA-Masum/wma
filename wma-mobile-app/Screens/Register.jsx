...
function Register({ navigation }) {
  ...
  const onPressHandler = () => {
    ...
    if(!phone){
      Alert.alert("Empty Input", "Phone Is Required!");
      phoneRef.current.focus();
      return;
    }
    if(phone.substring(0,3) !== '+88'&& !email){
    ...
    if(!agree){
      Alert.alert("Invalid Input", "You Have To Accept Our Terms & Conditions!");
      return;
    }
  };
      ...
      >
        ...
        <ScrollView style={{ width: "100%" }}>
          <View style={[styles.container, styles.horizontal]}>
            ...
            <View
              style={{ flexDirection: "row", alignItems: "center", width: 320 }}
            >
              <View style={styles.inputGroup}>
                <BouncyCheckbox
            ...
            >
              <Text style={{ fontSize: 20, color: colors.white, fontWeight: "bold", textTransform: "uppercase" }}>
                Register
              </Text>
            </TouchableOpacity>
          </View>
